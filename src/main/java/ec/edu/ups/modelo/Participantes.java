...
public class Participantes implements Serializable {
    ...
    public Participantes(String cedula) {
        this.cedula = cedula;
    }
    ...
    public String toString() {
        return "Participantes{" + "estadoCivil=" + estadoCivil + ", cedula=" + cedula + ", nombre=" + nombre + ", apellido=" + apellido + ", genero=" + genero + ", fechaNacimiento=" + fechaNacimiento + ", direccion=" + direccion + ", rol=" + rol + '}';
    }
